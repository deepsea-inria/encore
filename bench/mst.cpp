...
class almostKth : public encore::edsl::pcfg::shared_activation_record {
public:
  ...
  encore_private_activation_record_begin(encore::edsl, almostKth, 2)
    int lo; int hi;
  encore_private_activation_record_end(encore::edsl, almostKth, sar, par, dc, get_dc)
...
public:
  ...
  encore_private_activation_record_begin(encore::edsl, mst, 4)
    int lo; int hi;
  encore_private_activation_record_end(encore::edsl, mst, sar, par, dc, get_dc)
...
encore_pcfg_allocate(mst, get_cfg)
...
void benchmark(std::string infile) {
  ...
  d.add("encore", [&] {
    encore::launch_interpreter<encorebench::mst>(edges2, &result);
  });
  d.add("pbbs", [&] {
